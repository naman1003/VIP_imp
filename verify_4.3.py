...
while(i<=256):
		...
		for j in range(100):
			...
			for k in range(i):
				X_server1.append(X_mult_shares[k][0])
				X_server2.append(X_mult_shares[k][1])
				X_server3.append(X_mult_shares[k][2])
				Y_server1.append(Y_mult_shares[k][0])
				Y_server2.append(Y_mult_shares[k][1])
				Y_server3.append(Y_mult_shares[k][2])
			...
			seperate_data[1] = seperate_data[1] + sys.getsizeof(X_server1) + sys.getsizeof(X_server2) + sys.getsizeof(X_server3)
			seperate_data[2] = seperate_data[2] + sys.getsizeof(Y_server1) + sys.getsizeof(Y_server2) + sys.getsizeof(Y_server3)
			...
			seperate_data[3] = seperate_data[3] + sys.getsizeof(tow)
			...
			seperate_data[4] = seperate_data[4] + sys.getsizeof(T)
		...
		seperate_data[0] = i
		seperate_data[1] = seperate_data[1]/100
		seperate_data[2] = seperate_data[2]/100
		seperate_data[3] = seperate_data[3]/100
		seperate_data[4] = seperate_data[4]/100
